...
{
    public class ExcelDataExport : RPADataExport
    {
        /// <param name="ExcelPath"></param>
        /// <param name="Sheet"></param>
        /// <param name="range">如果忽略视为"A1"</param>
        /// <param name="MaxCashCount"></param>
        public ExcelDataExport(string ExcelPath = null, string Sheet = null, string range = "A1", bool withTitle = true, int MaxCashCount = 10000)
        {
